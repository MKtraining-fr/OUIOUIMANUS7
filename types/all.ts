/**
 * Ce fichier contient tous les types nécessaires pour l'application.
 * Il est conçu pour éviter les références circulaires entre les fichiers de types.
 */
...
// Types pour les commandes et tables
...
export interface Order {
  ...
  created_at: string;
  updated_at: string;
  promotions?: OrderPromotions; // Référence aux promotions appliquées
}
...
// Types pour les rapports et ventes
...
export const BASE_EDITABLE_ELEMENT_KEYS = [
  'navigation.brand',
...
export const INSTAGRAM_REVIEW_FIELDS = [
  ...INSTAGRAM_REVIEW_TEXT_FIELDS,
  ...INSTAGRAM_REVIEW_IMAGE_FIELDS,
] as readonly InstagramReviewField[];

export const INSTAGRAM_REVIEW_ELEMENT_KEYS = INSTAGRAM_REVIEW_IDS.flatMap(id =>
